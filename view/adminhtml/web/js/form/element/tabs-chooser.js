define([
    ...
    'mage/utils/objects',
    // 'uiRegistry'
], function ($, layout, Element, Config, $t, objectUtils/*, registry*/) {
    'use strict';
    ...
    return Element.extend({
        ...
        defaults: {
            template: 'Swissup_Easytabs/form/element/tabs-chooser',
        ...
        getStatusLabel: function () {
            return this.meta()['status'] === '1' ? $t('Active') : $t('Inactive');
        }
    });
});
